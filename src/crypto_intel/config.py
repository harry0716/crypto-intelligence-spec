...
def load_config(path: str | Path = "config/default.yaml") -> AppConfig:
    ...
    return AppConfig(
        ...
        reader_level=str(report.get("reader_level", "beginner")),
        max_event_age_hours=int(report.get("max_event_age_hours", 72)),
        max_events_per_source=int(report.get("max_events_per_source", 2)),
        minimum_independent_sources=int(report.get("minimum_independent_sources", 3)),
